export class Helper {
    ...
    public getValRange(numSmallest, numBiggest, denominator) { //100,999,7
        return {
            smallest: (numSmallest + (denominator - (numSmallest % denominator))) / denominator,
            biggest: Math.floor(numBiggest / denominator)
        }
    }
}